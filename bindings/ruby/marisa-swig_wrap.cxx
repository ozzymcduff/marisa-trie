...
SWIGINTERN VALUE
_wrap_Key_length(int argc, VALUE *argv, VALUE self) {
  marisa_swig::Key *arg1 = (marisa_swig::Key *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::size_t result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_marisa_swig__Key, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "marisa_swig::Key const *","length", 1, self )); 
  }
  arg1 = reinterpret_cast< marisa_swig::Key * >(argp1);
  {
    try {
...
_wrap_Query_length(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_marisa_swig__Query, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "marisa_swig::Query const *","length", 1, self )); 
  }
  arg1 = reinterpret_cast< marisa_swig::Query * >(argp1);
  {
    try {
...
SWIGINTERN VALUE
_wrap_Query_key_id(int argc, VALUE *argv, VALUE self) {
  marisa_swig::Query *arg1 = (marisa_swig::Query *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::size_t result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_marisa_swig__Query, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "marisa_swig::Query const *","key_id", 1, self )); 
  }
  arg1 = reinterpret_cast< marisa_swig::Query * >(argp1);
  {
    try {
...
_wrap_Keyset_push_back__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "char","push_back", 3, argv[1] ));
  } 
...
SWIGINTERN VALUE
_wrap_Keyset_push_back__SWIG_3(int argc, VALUE *argv, VALUE self) {
  marisa_swig::Keyset *arg1 = (marisa_swig::Keyset *) 0 ;
  char *arg2 = (char *) 0 ;
  std::size_t arg3 ;
  void *argp1 = 0 ;
...
SWIGINTERN VALUE _wrap_Keyset_push_back(int nargs, VALUE *args, VALUE self) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        if (argc <= 2) {
          return _wrap_Keyset_push_back__SWIG_3(nargs, args, self);
        }
        {
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "Keyset.push_back", 
    ...
    "    void Keyset.push_back(marisa::Key const &key, char end_marker)\n"
...
SWIGINTERN VALUE
_wrap_Trie_lookup(int argc, VALUE *argv, VALUE self) {
  marisa_swig::Trie *arg1 = (marisa_swig::Trie *) 0 ;
...
SWIGINTERN VALUE
_wrap_Trie_reverse_lookup(int argc, VALUE *argv, VALUE self) {
  marisa_swig::Trie *arg1 = (marisa_swig::Trie *) 0 ;
  marisa_swig::Agent *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGEXPORT void Init_marisa(void) {
  ...
  rb_define_const(mMarisa, "MARISA_OK", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_OK)));
  rb_define_const(mMarisa, "MARISA_STATE_ERROR", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_STATE_ERROR)));
  rb_define_const(mMarisa, "MARISA_NULL_ERROR", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_NULL_ERROR)));
  rb_define_const(mMarisa, "MARISA_BOUND_ERROR", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_BOUND_ERROR)));
  rb_define_const(mMarisa, "MARISA_RANGE_ERROR", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_RANGE_ERROR)));
  rb_define_const(mMarisa, "MARISA_CODE_ERROR", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_CODE_ERROR)));
  rb_define_const(mMarisa, "MARISA_RESET_ERROR", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_RESET_ERROR)));
  rb_define_const(mMarisa, "MARISA_SIZE_ERROR", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_SIZE_ERROR)));
  rb_define_const(mMarisa, "MARISA_MEMORY_ERROR", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_MEMORY_ERROR)));
  rb_define_const(mMarisa, "MARISA_IO_ERROR", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_IO_ERROR)));
  rb_define_const(mMarisa, "MARISA_FORMAT_ERROR", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_FORMAT_ERROR)));
  rb_define_const(mMarisa, "MARISA_MIN_NUM_TRIES", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_MIN_NUM_TRIES)));
  rb_define_const(mMarisa, "MARISA_MAX_NUM_TRIES", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_MAX_NUM_TRIES)));
  rb_define_const(mMarisa, "MARISA_DEFAULT_NUM_TRIES", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_DEFAULT_NUM_TRIES)));
  rb_define_const(mMarisa, "MARISA_HUGE_CACHE", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_HUGE_CACHE)));
  rb_define_const(mMarisa, "MARISA_LARGE_CACHE", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_LARGE_CACHE)));
  rb_define_const(mMarisa, "MARISA_NORMAL_CACHE", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_NORMAL_CACHE)));
  rb_define_const(mMarisa, "MARISA_SMALL_CACHE", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_SMALL_CACHE)));
  rb_define_const(mMarisa, "MARISA_TINY_CACHE", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_TINY_CACHE)));
  rb_define_const(mMarisa, "MARISA_DEFAULT_CACHE", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_DEFAULT_CACHE)));
  rb_define_const(mMarisa, "MARISA_TEXT_TAIL", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_TEXT_TAIL)));
  rb_define_const(mMarisa, "MARISA_BINARY_TAIL", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_BINARY_TAIL)));
  rb_define_const(mMarisa, "MARISA_DEFAULT_TAIL", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_DEFAULT_TAIL)));
  rb_define_const(mMarisa, "MARISA_LABEL_ORDER", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_LABEL_ORDER)));
  rb_define_const(mMarisa, "MARISA_WEIGHT_ORDER", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_WEIGHT_ORDER)));
  rb_define_const(mMarisa, "MARISA_DEFAULT_ORDER", SWIG_From_int(static_cast< int >(marisa_swig::MARISA_DEFAULT_ORDER)));
  ...
  rb_define_method(SwigClassKey.klass, "length", VALUEFUNC(_wrap_Key_length), -1);
  ...
  rb_define_method(SwigClassQuery.klass, "key_id", VALUEFUNC(_wrap_Query_key_id), -1);
